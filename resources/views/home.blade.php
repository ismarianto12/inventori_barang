...
<div class="card">
    ...
    <div class="card-body p-0">
        <div class="lightSlider" data-item="6" data-item-xl="4" data-item-md="2" data-item-sm="1" data-pause="7000" data-pager="false" data-auto="true"
         ...
         <img src="{{ asset('public/foto/'.$dt->foto) }}" class="img-responsive" style="height: 200px;width:200px"  alt="Image not found" onerror="this.src='{{ asset('template/img/centos7.jpg') }}';">
