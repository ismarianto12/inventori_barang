    ...
    public function api_table()
    {
        ...
        return Datatables::of($fdata)
            ...
            ->editColumn('foto_barang', function ($fdata) {
                $error = 'onerror="this.src="public/template/img/centos7.jpg";"';  
                $foto = '<img src="' . asset('public/foto/' . $fdata->foto) . '" class="img-responsive" style="width:100px;height:100px"  alt="Image not found" '.$error.'>';
                return $foto;
            })
            ->addIndexColumn()
